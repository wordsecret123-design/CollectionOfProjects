...
if __name__ == "__main__":
    ...
    trainSetDF,validSetDF = trainingValidationSplitWithNaN(df,"date")
    print("mean")
    print(trainSetDF["posted_rate"].mean())
    print(validSetDF["posted_rate"].mean())
    print("median")
    print(trainSetDF["posted_rate"].median())
    print(validSetDF["posted_rate"].median())
    print("max")
    print(trainSetDF["posted_rate"].max())
    print(validSetDF["posted_rate"].max())
    print("min")
    print(trainSetDF["posted_rate"].min())
    print(validSetDF["posted_rate"].min())
    print("standard deviation")
    print(trainSetDF["posted_rate"].std())
    print(validSetDF["posted_rate"].std())
